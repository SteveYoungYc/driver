...
static long at24c02_ioctl(struct file *file, unsigned int cmd,
                          unsigned long arg) {
  unsigned char addr;
  unsigned char data;
...
static const struct i2c_device_id at24c02_ids[] = {{"", (kernel_ulong_t)NULL},
                                                   {/* END OF LIST */}};
...
static void at24c02_exit(void) { i2c_del_driver(&at24c02_drv); }
